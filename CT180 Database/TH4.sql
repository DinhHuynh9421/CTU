...
where lower(hoten_cn)= 'nguyen hong van' and 'dec-18-1994' between ngay_tgia and ngay_tgia + so_ngay;
--23
select hoten_kts
from cgtrinh c join thietke t on c.stt_ctr=t.stt.ctr
where ten_thau='phong dich vu so xd'
INTERSECT
select hoten_kts
from ctrinh c join thietke t on c.stt_ctr=t.stt_ctr
...
where a.hote_cn<b.hoten_cn
group by a.hoten_cn, b.hoten_cn having count(*)>1;
--31
select distinct a.hoten_kts, b.hoten_kts
from thietke a join thietke b on a.stt_ctr=b.stt_ctr
